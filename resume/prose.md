...
**Software Developer, OpenDP, Harvard (October 2023-present)**: Supported the differential privacy researcher and user communities, and contributed to software implementing differential privacy, the addition of calibrated noise to statistics to protect individual privacy. Supported the planning and execution of annual community meetings, smaller workshops, and the summer internship program, and managed agendas and took notes for team meetings. Improved the testing, documentation, usability, and maintainability of the [OpenDP Library](https://docs.opendp.org/), focussing on the Python APIs and code generation in Rust. Designed and implemented [DP Wizard](https://github.com/opendp/dp-wizard), a GUI application which generates customized notebooks demonstrating the OpenDP Library. Authored schema and data validation tools for the [Differential Privacy Deployments Registry](https://github.com/opendp/deployments-registry-data/).

**Educator, Old North Illuminated (April 2023-present); Tour Guide, Historic New England (April 2023-September 2024)**: At
[Old North Church](https://www.oldnorth.com/about-old-north-illuminated/) and the [Cooper-Frost-Austin House](https://www.historicnewengland.org/property/cooper-frost-austin-house/), welcomed diverse visitors and explained the history and continuing significance of these sites through scripted tours and spontaneous conversations. Conducted archival research on the 1912 renovation of Old North, and consistently enforced policies to ensure the safety of visitors and the preservation of the sites.
